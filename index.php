...
<html lang="fr">
    <head>
        ...
        <meta name="description" content="Portfolio de Pascal Crochard - BTS SIO">
        <meta name="author" content="Pascal Crochard">

        <!-- Bootstrap CSS -->
        <link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/bootstrap@4.6.1/dist/css/bootstrap.min.css" integrity="sha384-zCbKRCUGaJDkqS1kPbPd7TveP5iyJE0EjAuZQTgFLD2ylzuqKfdKlfG/eSrtxUkn" crossorigin="anonymous">

        <title>Portfolio de Pascal Crochard (BTS SIO 2021)</title>
...
Fiches d'examen</li>
        ...
        <div class="jumbotron">
            <h1>Bonjour, j'ai pas eu le temps de modifier le portfolio à mon gout je me pencherai dessus ce vendredi 12 janvier après midi</h1>
            <section id="intro">
            <img src="images/AmeliaPilou.jpg" alt=" " class="mr-4 float-left">
            <p>
Je m'appelle Amélia pilou, j'ai 21 ans et ce site a pour vocation
                de me présenter en temps que personne, en temps qu'étudiante et candidate
                à l'obtention du BTS SIO (Services Informatiques aux Organisations) et en
                tant que future professionnelle de l'informatique
            </p>
            <p>
            <a class="btn btn-primary " href="https://github.com/ChaBoxxHF/ChaBoxxHF.github.io" target="_blank"
